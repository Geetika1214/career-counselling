    ...
    <div className="relative min-h-screen bg-gray-100 text-gray-900">
      ...
      <div className="py-12 text-center w-full px-6">
        ...
        <div className="flex gap-6 justify-center">
          <Link
            to="/quiz"
            className="bg-yellow-400 text-gray-900 px-6 py-3 rounded-lg shadow-lg font-semibold transition duration-300 transform hover:scale-105 hover:bg-yellow-300"
          >
            Get Started 🚀
          </Link>
        </div>
